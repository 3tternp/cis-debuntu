...
- **Consent Prompt Introduced**:
  - Before executing the audit, the script prompts the user: _"Do you want to continue? (yes/no)"_
...
- Test suite is assumed common to both Ubuntu and Debian for now.
  > _Note: Debian-specific benchmarks may differ. The script currently uses a unified suite._
